...
DEF("heca", HAS_ARG, QEMU_OPTION_heca,
    "-heca [hspaceid=value][,mode=master|slave[,hprocid=id][,masterip=ip]"
    "[,rdma_port=port][,mng_port=port]]\n" \
...
DEF("hecaproc", HAS_ARG, QEMU_OPTION_hecaproc,
    "-hecaproc [hprocid=id][,ip=ip][,rdma_port=port][,mng_port=port]\n" \
    "           Define heca_process information. Has to follow "
    "'-heca mode=master' parameter.\n",
    QEMU_ARCH_ALL)
STEXI
@item -hecaproc
@findex -hecaproc
...
DEF("hecamr", HAS_ARG, QEMU_OPTION_hecamr,
    ...
    "           Define heca_memory_region information." 
    "Has to follow -heca mode=master parameter.\n",
    QEMU_ARCH_ALL)
STEXI
@item -hecamr
@findex -hecamr
